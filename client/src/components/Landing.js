          ...
          <section id="about">
            ...
            <div className="features">
              ...
              <div className="ftr">
                <h3>Fast delivery</h3>
                <p>
                  We make sure we deliver your food fresh from the oven just
                  like you would have it if you just made it yourself. We change
                  a recipe for you liking making it even better for you.
                </p>
              </div>
            </div>
            <div className="features">
              ...
              <div className="ftr">
                <h3>Great prices</h3>
                <p>
                  Our food is extremely affordable! It is just like you would
                  make it yourself but even better.
                </p>
              </div>
            </div>
          </section>
